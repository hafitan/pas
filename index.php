...
<body>
    <!-- <section class="login py-5 bg-light"> -->
        <div class="container">
            <div style="background-image: url('img/logg.jpeg'); background-size: 1299px 520px; background-repeat: no-repeat;" class="row g-0">
                <!-- <div class="col-lg-5"> -->
                    <!-- <img style="" src="img/logg.jpeg" class="" alt=""> -->
                <!-- </div> -->
