                ...
                <div class="mb-3 row py-3">
                    ...
                    <div class="col-sm-7">
                        <div id="myselection" class="col"> 
                            <input   type="radio" class="btn-check" <?php if(@$rd['jk']=="L"){ echo "checked";} ?> name="jk" value="Laki-laki" id="l" autocomplete="off" >
                        </div>
                        <label class="btn btn-outline-dark" for="l">L</label>
                        <label class="btn btn-outline-dark" for="p">P</label>

                        <div id="selection" class="col">
                            <input type="radio" class="btn-check" <?php if(@$rd['jk']=="P"){ echo "checked";} ?> name="jk" value="Perempuan" id="p" autocomplete="off" >
                        </div>
                    </div>
                </div>
                <?php if(@$_GET['id'] == ""){}else{ ?>
