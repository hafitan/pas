<?php
    $field = array(
        ...
        $field2 = array(
            'id' => @$_POST['nis'],
        'username' => substr(@$_POST['nama'],0,5)."@smkwikrama.sch.id",
        'nama' => @$_POST['nama'],
        'password' => substr(@$_POST['nama'],0,5)."123",
        'role' => "siswa"
        );
    ...
    <div class="container">
        <div class="row g-0">
            <div class="col">
                ...
                <div class="col-sm-7">
                <input required type="radio" class="btn-check" <?php if(@$rd['jk']=="L"){ echo "checked";} ?> name="jk" value="Laki-laki" id="l" autocomplete="off" >
                <label class="btn btn-outline-dark" for="l">L</label>
                <input required type="radio" class="btn-check" <?php if(@$rd['jk']=="P"){ echo "checked";} ?> name="jk" value="Perempuan" id="p" autocomplete="off" >
